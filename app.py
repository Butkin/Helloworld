...
app = App("John")       #app to jest zmienna ktora przechowuje instancje klasy App. Klasa App jest pewnym typem funcji.
#app.init()        # wywołujemy funkcje z naszej klasy App 935
